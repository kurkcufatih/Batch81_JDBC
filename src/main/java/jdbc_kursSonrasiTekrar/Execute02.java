...
public class Execute02 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql1 = "select country_name from my_countries where region_id=1";
        ...
        String sql2 = "select country_id, country_name from my_countries where region_id>2";
        ...
        String sql3 = "select * from my_companies where number_of_employees =(select min(number_of_employees) from my_companies)";
